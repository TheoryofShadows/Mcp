...
// installs/rating/rating_count (always seeded 0 — no vanity social proof),
// price_type, price_amount(¢), verified, trending, weekly_growth (null),
// repo_url, tags[], license. Gradient is assigned from a palette below.
...
const servers = [
  ...
  S({ name: "GitHub MCP Server", slug: "github-mcp-server", author: "github", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/github/github-mcp-server", license: "MIT",
  ...
  S({ name: "Filesystem MCP", slug: "filesystem-mcp", author: "modelcontextprotocol", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/modelcontextprotocol/servers", license: "MIT",
  ...
  S({ name: "Playwright MCP", slug: "playwright-mcp", author: "microsoft", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/microsoft/playwright-mcp", license: "Apache-2.0",
  ...
  S({ name: "Context7", slug: "context7", author: "upstash", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/upstash/context7", license: "MIT",
  ...
  S({ name: "Git MCP", slug: "git-mcp", author: "modelcontextprotocol", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/modelcontextprotocol/servers", license: "MIT",
  ...
  S({ name: "Docker MCP", slug: "docker-mcp", author: "ckreiling", category: "dev",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/ckreiling/mcp-server-docker", license: "MIT",
  ...
  S({ name: "Hugging Face MCP", slug: "hugging-face-mcp", author: "exalabs", category: "ai",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/huggingface/hf-mcp-server", license: "Apache-2.0",
  ...
  S({ name: "Supabase MCP", slug: "supabase-mcp", author: "supabase", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/supabase-community/supabase-mcp", license: "Apache-2.0",
  ...
  S({ name: "Firecrawl MCP", slug: "firecrawl-mcp", author: "firecrawl", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "paid", price_amount: 1600, verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/mendableai/firecrawl-mcp-server", license: "MIT",
  ...
  S({ name: "Exa Search MCP", slug: "exa-search-mcp", author: "exalabs", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "paid", price_amount: 1000, verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/exa-labs/exa-mcp-server", license: "MIT",
  ...
  S({ name: "Tavily MCP", slug: "tavily-mcp", author: "tavily", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "paid", price_amount: 900, verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/tavily-ai/tavily-mcp", license: "MIT",
  ...
  S({ name: "Redis MCP", slug: "redis-mcp", author: "redis", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/redis/mcp-redis", license: "MIT",
  ...
  S({ name: "MongoDB MCP", slug: "mongodb-mcp", author: "mongodb", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/mongodb-js/mongodb-mcp-server", license: "Apache-2.0",
  ...
  S({ name: "Qdrant MCP", slug: "qdrant-mcp", author: "qdrant", category: "data",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/qdrant/mcp-server-qdrant", license: "Apache-2.0",
  ...
  S({ name: "Notion MCP", slug: "notion-mcp", author: "notion", category: "business",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/makenotion/notion-mcp-server", license: "MIT",
  ...
  S({ name: "Stripe MCP", slug: "stripe-mcp", author: "stripe", category: "business",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/stripe/agent-toolkit", license: "MIT",
  ...
  S({ name: "Linear MCP", slug: "linear-mcp", author: "sooperset", category: "business",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/jerhadf/linear-mcp-server", license: "MIT",
  ...
  S({ name: "Atlassian MCP", slug: "atlassian-mcp", author: "sooperset", category: "business",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/sooperset/mcp-atlassian", license: "MIT",
  ...
  S({ name: "Blender MCP", slug: "blender-mcp", author: "ahujasid", category: "creative",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/ahujasid/blender-mcp", license: "MIT",
  ...
  S({ name: "Figma Context MCP", slug: "figma-context-mcp", author: "glips", category: "creative",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/GLips/Figma-Context-MCP", license: "MIT",
  ...
  S({ name: "ElevenLabs MCP", slug: "elevenlabs-mcp", author: "elevenlabs", category: "creative",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "paid", price_amount: 1100, verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/elevenlabs/elevenlabs-mcp", license: "MIT",
  ...
  S({ name: "Cloudflare MCP", slug: "cloudflare-mcp", author: "cloudflare", category: "infra",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/cloudflare/mcp-server-cloudflare", license: "Apache-2.0",
  ...
  S({ name: "AWS MCP", slug: "aws-mcp", author: "awslabs", category: "infra",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 1,
    weekly_growth: null, repo_url: "https://github.com/awslabs/mcp", license: "Apache-2.0",
  ...
  S({ name: "Sentry MCP", slug: "sentry-mcp", author: "sentry", category: "infra",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/getsentry/sentry-mcp", license: "MIT",
  ...
  S({ name: "Grafana MCP", slug: "grafana-mcp", author: "grafana", category: "infra",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/grafana/mcp-grafana", license: "Apache-2.0",
  ...
  S({ name: "Kubernetes MCP", slug: "kubernetes-mcp", author: "flux159", category: "infra",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/Flux159/mcp-server-kubernetes", license: "MIT",
  ...
  S({ name: "Chess Analysis MCP", slug: "chess-analysis-mcp", author: "punkpeye", category: "creative",
    ...
    installs: 0, rating: 0, rating_count: 0, price_type: "free", verified: 0, trending: 0,
    weekly_growth: null, repo_url: "https://github.com/punkpeye/mcp-chess", license: "MIT",
...
const GRADIENTS = [
  ...
  "linear-gradient(135deg, #6f6d67, #8a9a86)",
  "linear-gradient(135deg, #8a9a86, #6f6d67)",
  "linear-gradient(135deg, #c4a574, #c45c4a)",
  "linear-gradient(135deg, #8a9a86, #c4a574)",
];
...
// ─── Reviews ───
// No sample reviews. Fake reviews inflate Trust Score satisfaction.

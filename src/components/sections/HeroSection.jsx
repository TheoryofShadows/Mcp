  ...
  return (
    ...
    >
      ...
      <div className="animate-in" style={{ position: "relative", zIndex: "var(--z-card)" }}>
        <div aria-live="polite" style={{ display: "inline-flex", alignItems: "center", gap: "var(--space-sm)", padding: "6px 16px", background: "rgba(77, 255, 180, 0.06)", border: "1px solid rgba(77, 255, 180, 0.15)", borderRadius: "30px", marginBottom: "28px" }}>
          <span aria-hidden="true" style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--accent-electric)", animation: "pulse-glow 2s ease-in-out infinite" }} />
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--font-sm)", color: "var(--accent-electric)", letterSpacing: "1px" }}>

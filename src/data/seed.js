...
Pass allowed directories as positional arguments.`,
    ...
    gradient: "linear-gradient(135deg, #10b981, #7c6cff)",
    installs: 127500,
    rating: 4.8,
    review_count: 589,
    weekly_growth: "+12%",
...
⚠️ Use a restricted API key with only the permissions your agent needs.`,
    ...
    gradient: "linear-gradient(135deg, #7c6cff, #a78bfa)",
    installs: 43100,
    rating: 4.8,
    review_count: 231,
    weekly_growth: "+41%",
...
Pass your connection string as the last argument.`,
    ...
    gradient: "linear-gradient(135deg, #3b82f6, #7c6cff)",
    installs: 58400,
    rating: 4.9,
    review_count: 344,
    weekly_growth: "+15%",
...
\`\`\``,
    ...
    gradient: "linear-gradient(135deg, #f97316, #7c6cff)",
    installs: 61200,
    rating: 4.7,
    review_count: 287,
    weekly_growth: "+31%",
...
\`\`\``,
    ...
    gradient: "linear-gradient(135deg, #7c6cff, #06b6d4)",
    installs: 22300,
    rating: 4.7,
    review_count: 112,
    weekly_growth: "+23%",
...
\`\`\``,
    ...
    gradient: "linear-gradient(135deg, #e5e7eb, #7c6cff)",
    installs: 31600,
    rating: 4.5,
    review_count: 203,
    weekly_growth: "+11%",
...
- Availability-based calendar management`,
    ...
    gradient: "linear-gradient(135deg, #0ea5e9, #7c6cff)",
    installs: 29800,
    rating: 4.7,
    review_count: 156,
    weekly_growth: "+33%",

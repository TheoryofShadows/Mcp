...
| **Pro Publisher** | $9/mo | Unlimited servers, priority listing & discovery, revenue analytics, webhooks |
| **Enterprise** | $29/mo | Team roles, private marketplace, SLA, dedicated support, SSO/SAML |

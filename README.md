...
| **Pro Publisher** | $9/mo | Serious publishers building a business. Unlimited servers, priority listing, revenue analytics dashboard, custom branding, webhook integrations. |
| **Enterprise** | $29/mo | Teams and organizations at scale. Private marketplace, team management, SSO/SAML, SLA (99.9% uptime), dedicated support engineer, custom contracts. |
...
- [x] `npx @mcpx-digital/cli install <slug>` — trust-enforcing CLI installer ([`cli/`](cli/))
- [x] Repo ownership verification (`.mcpx-verify`) + source-scan-aware Trust Score
- [x] Reference MCP server: [`@mcpx-digital/railway`](railway-mcp/)
